...
def main():
    ...
    cloud:
    python export_inference_graph.py --input_type image_tensor --pipeline_config_path /home/njuthapr/model/faster_rcnn_resnet50/pipeline.config --trained_checkpoint_prefix /home/njuthapr/trained_faster_rcnn_resnet50/model.ckpt-200000 --output_directory /home/njuthapr/trained_faster_rcnn_resnet50/inference_graph

    faster_rcnn_resnet101:
    cloud:
    python export_inference_graph.py --input_type image_tensor --pipeline_config_path /home/njuthapr/model/faster_rcnn_resnet101/pipeline.config --trained_checkpoint_prefix /home/njuthapr/trained_faster_rcnn_resnet101/model.ckpt-278074 --output_directory /home/njuthapr/trained_faster_rcnn_resnet101/inference_graph
    ...
    cloud:
    python export_inference_graph.py --input_type image_tensor --pipeline_config_path /home/njuthapr/trained_rfcn_resnet101/pipeline.config --trained_checkpoint_prefix /home/njuthapr/trained_rfcn_resnet101/model.ckpt-200000 --output_directory /home/njuthapr/trained_rfcn_resnet101/inference_graph
    ...
    PATH_TO_FROZEN_GRAPH = '/home/njuthapr/trained_faster_rcnn_resnet101/inference_graph/frozen_inference_graph.pb'
    PATH_TO_FROZEN_GRAPH = '/home/njuthapr/trained_rfcn_resnet101/inference_graph/frozen_inference_graph.pb'
    ...
    abs_img_path = '/home/njuthapr/new_dataset/'
    ...
    df_label = pd.read_csv('/home/njuthapr/label_test_train.csv',index_col=0)
    ...
    try:
        with detection_graph.as_default():
            with tf.Session() as sess:
                ...
                df_score.to_csv('/home/njuthapr/label_score.csv',index=None)
